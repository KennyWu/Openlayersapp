...
class SelectCustom extends HTMLElement {
  ...
  constructor() {
    ...
    this.#back.addEventListener("click", this.changeOption(false).bind(this));
    this.#forward.addEventListener("click", this.changeOption(true).bind(this));
    this.#size = 0;
